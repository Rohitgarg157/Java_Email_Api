...
//    }
    ...
    public GenericResponse resetPassword(final HttpServletRequest request, @RequestParam("email") final String userEmail) {
        if (userEmail == null || userEmail.isEmpty()) {
            return new GenericResponse("Please provide a valid email address.");
        }
        ...
        if (user != null) {
            ...
            try {
                ...
                return new GenericResponse("There was an error sending the password reset email. Please try again later.");
            }

           
            return new GenericResponse("Password reset instructions have been sent to your email.");
        }

        // Respond with success even if user is not found, to prevent email enumeration
        return new GenericResponse("If your email is registered, password reset instructions have been sent.");
    }
    ...
    private SimpleMailMessage constructResetTokenEmail(final String contextPath, final Locale locale, final String token, final User user) {
        ...
        // The message body with user instructions
