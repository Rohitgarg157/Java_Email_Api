...
//    }
    ...
    @Override
    public void createPasswordResetTokenForUser(final User user, final String token) {
        System.out.println("Saving token: " + token + " for user: " + user.getEmail());
...
//    }
    ...
    public Optional<User> getUserByPasswordResetToken(final String token) {
        ...
        if (passwordResetToken == null) {
            System.out.println("No PasswordResetToken found for token: " + token);
            return Optional.empty();  // Return empty Optional if no token is found
        }
